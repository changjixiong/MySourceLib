...
class ConnectionManager
{
	...
	typedef std::list< Connection > clist;
    typedef std::list< Connection >::iterator clistitr;
...
NewConnection( DataSocket& p_socket )
{
    ...
    else
    {
        ...
        Connection& c = *m_connections.rbegin();
...
// ------------------------------------------------------------------------
void ConnectionManager::Close( clistitr p_itr )
{
