...
// --------------------------------------------------------------------
UserDatabase::iterator UserDatabase::find( Connection* p_connection )
{
...
// --------------------------------------------------------------------
bool UserDatabase::AddUser( Connection* p_connection, string p_name )
{
...
// --------------------------------------------------------------------
void UserDatabase::DeleteUser( Connection* p_connection )
{
    iterator itr = find( p_connection );
    if( itr != m_users.end() )
	{
		BasicLib::DeBugOut("delete "+itr->name);
        m_users.erase( itr );
	}
