...
std::string ParseWord( const std::string& p_string, int p_index, const std::string separator=WHITESPACE );
std::string RemoveWord( const std::string& p_string, int p_index, const std::string separator=WHITESPACE );
